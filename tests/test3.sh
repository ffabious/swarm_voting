...
function run_robots() {
    python robot.py -f setup5.json -a 1 &
    python robot.py -f setup5.json -a 2 &
    python robot.py -f setup5.json -a 3 &
    python robot.py -f setup5.json -a 4 &
    python robot.py -f setup5.json -a 5
}
